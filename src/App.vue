...
const showNavBar = computed(() => {
  ...
  const hiddenPaths = ['/dashboard', '/model-generation', '/pose-generation', '/upscale', '/gallery', '/albums', '/projects', '/settings', '/subscription', '/usage-history', '/purchase-history', '/invitation']
